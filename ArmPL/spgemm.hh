  ...
  void toSparseFormat() override {
    ...
    do {
      if (type_ == matrixType::rmat) {
        ...
        bandedDiagonalCSR<T, armpl_int_t>(A_vals_, A_cols_, A_rows_, m_armpl_, k_armpl_, nnzA_armpl_, SEED + seedOffset++);
        bandedDiagonalCSR<T, armpl_int_t>(B_vals_, B_cols_, B_rows_, k_armpl_, n_armpl_, nnzB_armpl_, SEED + seedOffset++);
      } else {
