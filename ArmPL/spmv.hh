...
protected:
  void toSparseFormat() override {
    ...
    if (type_ == matrixType::rmat) {
      ...
      bandedDiagonalCSR<T, armpl_int_t>(A_vals_, A_cols_, A_rows_, m_armpl_, n_armpl_, nnz_);
    } else {
...
private:/** Perform any required steps before calling the spmv kernel that should
   * be timed. */
