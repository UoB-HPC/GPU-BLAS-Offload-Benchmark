...
namespace gpu {
/** A class for SpGEMV GPU BLAS kernels. */
template <typename T>
...
protected:
 ...
 private:
  void preLoopRequirements() override {
    ...
    //     break;
    // }
    // std::string mes = func + off + std::to_string(m_) + "x" + std::to_string(n_);
    // eventAttrib.message.ascii = mes.data();
