...
/** A generic abstract class defining the operation of timing a SpGEMM BLAS
...
private:
    /** Performs the steps required before calling the SpGEMM kernel that
     * should be timed */
    virtual void preLoopRequirements() = 0;

    /** Perform the SpGEMM kernel. */
    virtual void callSpgemm() = 0;

    /** Perform any steps required after calling the SpGEMM kernel that should
     * be timed */
