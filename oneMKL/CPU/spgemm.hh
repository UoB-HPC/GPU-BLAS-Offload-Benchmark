    ...
    void toSparseFormat() override {
      ...
      do {
        if (type_ == matrixType::rmat) {
          ...
          bandedDiagonalCSR<T, MKL_INT>(A_vals_, A_cols_, A_rows, m_, k_, A_nnz_, SEED + seedOffset++);
          bandedDiagonalCSR<T, MKL_INT>(B_vals_, B_cols_, B_rows, k_, n_, B_nnz_, SEED + seedOffset++);
        } else {
